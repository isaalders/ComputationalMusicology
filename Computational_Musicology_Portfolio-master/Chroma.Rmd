...
compmus_long_distance(
    tallis %>% mutate(pitches = map(pitches, compmus_normalise, 'euclidean')), # You only need to change the names of your trakcs, so in this case the tallis and chapelle. Also change your norm to what you want, bv euclidean and change the distances (method)
    ...
    theme_minimal() # The diagnoal line represent the dynamic time warp.
```
